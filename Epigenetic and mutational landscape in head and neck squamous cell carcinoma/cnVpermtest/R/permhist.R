...
#'
#' @description This function allows you to make histogram for CNA permutation.
...
#' @param position Position of the lable of observed overlap value, right or left of the marked dashed line, default is Right
#' \itemize{
