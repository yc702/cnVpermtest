#' A CNA permutation function for CNA amplification and deletion
#'
#' @description This function allows you to do permutation of CNA segments for CNA amplification and deletion.
...
#' @param segment_cutoff Cut off value (positive or negative) of CNA segments in CNA data lists for amplification and deletion
