...
tcgacnv.amp <- function(cnvdatalist,segmentmean_name,segment_cutoff,permtime,core){
...
tcgacnv.del<-function(cnvdatalist,segmentmean_name,segment_cutoff,permtime,core){
